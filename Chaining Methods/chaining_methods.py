...
muath.make_deposit(500).make_deposit(100).make_deposit(150).make_withdrawal(100)
print("Muath's balance:", muath.account_balance)
kareem.make_deposit(300).make_deposit(150).make_withdrawal(50).make_withdrawal(80)
print("Kareem's balance:", kareem.account_balance)
yazan.make_deposit(300).make_withdrawal(50).make_withdrawal(100).make_withdrawal(50)
print("Yazan's balance:", yazan.account_balance)
muath.display_user_balance().transfer_money(yazan,50)
